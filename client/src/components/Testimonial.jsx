...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50">
      ...
      />
      <div className="flex flex-wrap items-center justify-center gap-12 pt-25">
        <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 sm:mb-12">
