...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="MyBookings"
        subTitle="Easily manage your past, current amd upcoming hotel reservations in one place. Plan your trips seamlessly with just a few clicks"
        align="left"
      />
        ...
        {bookings.map((bookings) => (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row">
              ...
              />
              <div className="flex flex-col gap-1 text-sm text-gray-500 ml-3">
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!bookings.isPaid && (
                <button className="px-4 py-1.5 mt-4 tetx-xs border border-gray-400 rounded-full hover:bg-gray-50 transition-all cursor-pointer">
                  Pay Now
                </button>
              )}
            </div>
